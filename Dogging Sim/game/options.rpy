...
define config.name = _("Dogging Sim")
...
define config.main_menu_music = "Go_to_Sleep_My_Little_One.mp3"
...
define config.save_directory = "DoggingSim-1542621683"
