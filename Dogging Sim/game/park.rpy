...
label park_start:
    ...
    elif dog.traits.energy > #ENERGY_THRESH: and dog.traits.passAggress > #PASS_THRESH:
...
label park_fetch_start:
	...
	if dog.traits.gluttony > #GLUTTONY_THRESH:
		...
		menu:
			...
			"Feed #HER a dog treat.":
				...
				$ dog.traits.gluttony += #GLUTTONY_INCR
	...
	elif dog.traits.social > #SOCIAL_THRESH:
		d "Arf! Arf! Arf!"
...
label park_fetch_throw_1
	...
	if dog.traits.passAggress > #AGGRESSION_THRESH:
...
label park_meet_cocoa
	...
	if dog.traits.passAggress > #AGGRESSION_THRESH:
		...
		menu:
			"Pet Cocoa":
				if dog.traits.jealousy > #JEALOUSY_THRESH:
					d "Whiiiiine..."
